...
"        call setline(1,"<head><meta charset=\"UTF-8\"></head>")
		...
		call append(line(".")+1, "	> Author: KIDJourney") 
		call append(line(".")+2, "	> Mail: kingdeadfishcn@gmail.com") 
	...
	if &filetype == 'cpp'
		...
		call append(line(".")+14, "const int Maxn=2e6+3;")
		call append(line(".")+15, "const int MaxHashSize=(1<<16)+3;")
